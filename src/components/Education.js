        ...
        <div className="d-flex justify-content-between">
          ...
          <div className="center-col">
            ...
            <ul>
                ...
                <li className="educationDetail">- Developing screens and UI components for the web application using React and Tailwind.</li>
            </ul>
          ...
          <div className="right-col">2019 / 2022</div>
        </div>
        <hr
          style={{
            height: 1,
